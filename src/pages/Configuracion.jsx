        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 max-w-lg">
            ...
            <form onSubmit={invitarUsuario} className="space-y-3">
              ...
              {mensajeInvitacion && (
                <p className={`text-sm ${mensajeInvitacion.tipo === 'exito' ? 'text-green-600' : 'text-red-500'}`}>
              ...
              <div className="bg-blue-50 rounded-lg p-3">
                <p className="text-xs text-blue-700">
                  📧 El usuario recibirá un email con un link para crear su contraseña y acceder a SENTRA.
                </p>
              </div>
